...
function CreateProduct(id,name,price,stars,photo){
    ...
    `
        ...
        <div class="value d-flex align-items-center">
            <span id="popular-price-0">${price}</span>$
        </div>
        <div class="d-flex button-block text-dark">
            <button id="add-${id}" type="button" class="btn btn-primary w-100 d-flex align-items-center justify-content-center" data-toggle="button" aria-pressed="false">
                Add to Cart
